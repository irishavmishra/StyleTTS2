...
# Set environment variables for espeak on Windows
os.environ["PHONEMIZER_ESPEAK_LIBRARY"] = "C:\\Program Files\\eSpeak NG\\espeak-ng.exe"
# os.environ["PHONEMIZER_ESPEAK_DATA"] = "C:\\Program Files\\eSpeak NG\\espeak-ng-data"
...
class StyleTTS2Inference:
    def __init__(self, config_path, model_path):
        ...
        # Custom phonemizer for Windows compatibility
        try:
...
if __name__ == "__main__":
    ...
    ref_style = synthesiser.compute_style("Models/LibriTTS/man.wav")

    # Generate speech
    audio = synthesiser.inference(
        text="Hi, I'm Rishav Mishra, and I'm building an AI voice cloning system from scratch, including fine-tuning models and self-hosting for complete control and customization.",
        ref_s=ref_style,
    )
